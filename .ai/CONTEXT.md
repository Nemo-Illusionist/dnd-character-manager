...
### Что в процессе
- Компендиум
- Улучшение UI листа персонажа

### Недавно реализовано
- Мультиклассирование (несколько классов, распределение уровней, combined spell slots)
- Разделение global level (из XP) и class levels
- Pact Magic для Warlock отдельно от обычных слотов
...
См. `CLAUDE.md` в корне проекта:
- Правила D&D 2024 проверять через агента `@dnd-2024`
